...
// Navbar
// ─────────────────────────────────────────────────────────────────
function Navbar({ darkMode, onToggleDark, navigate }) {
...
export default function LandingPage({ darkMode, onToggleDark }) {
  ...
  return (
    ...
    >
      <Navbar darkMode={darkMode} onToggleDark={onToggleDark} navigate={navigate} />
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <motion.p
            ...
            style={{ fontSize: 18, color: muted, lineHeight: 1.7, maxWidth: 580, margin: '0 auto 44px' }}
          >
      ...
      {/* ═══════════════════════════════════════════════════════════
          HOW IT WORKS
      ═══════════════════════════════════════════════════════════ */}
      <section id="how-it-works" style={{ padding: '100px 5%', background: darkMode ? '#101010' : '#f5f5f5' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <Reveal>
      ...
      <section style={{ padding: '80px 5% 100px' }}>
        <Reveal>
          <div style={{
            ...
            padding: '70px 48px', borderRadius: 28,
