...
export default function AnalyticsPage() {
  ...
  return (
    <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 lg:ml-64 bg-surface min-h-screen">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          ...
          <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="p-6">
              <div className="h-48 flex items-end gap-2 sm:gap-3 px-1 sm:px-4 relative">
                {CHART_DATA.map((d, i) => (
                  <div
                    key={d.day}
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm">
          ...
          <div className="p-4 sm:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            {/* Vector DB */}
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex">
                    <input
                      className="min-w-0 flex-1 border border-slate-200 rounded-l-xl px-3 py-2.5 text-xs font-mono focus:outline-none focus:ring-2 focus:ring-secondary/30"
                      type="password"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 p-3 bg-slate-50 border border-slate-100 rounded-xl">
