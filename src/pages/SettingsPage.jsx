...
export default function SettingsPage() {
  ...
  return (
    <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 lg:ml-64 bg-surface min-h-screen">
      {saved && (
        <div className="fixed bottom-4 right-4 left-4 sm:left-auto sm:bottom-6 sm:right-6 z-50 bg-primary-container text-white px-5 py-3 rounded-xl shadow-2xl flex items-center gap-3 text-sm font-semibold">
          ...
          <div className="bg-white rounded-2xl border border-outline-variant shadow-sm p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={n.key} className="flex items-start sm:items-center justify-between gap-4 py-2">
                  <div>
