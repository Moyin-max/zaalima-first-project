...
export default function AdminDashboard() {
  ...
  return (
    <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 lg:ml-64 bg-surface dark:bg-[#0f1117] min-h-screen transition-colors">
      {toastMsg && (
        <div className="fixed bottom-4 right-4 left-4 sm:left-auto sm:bottom-6 sm:right-6 z-50 bg-primary-container text-white px-5 py-3 rounded-xl shadow-2xl flex items-center gap-3 text-sm font-semibold animate-fade-in">
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="bg-white dark:bg-[#1a1d27] rounded-2xl border border-slate-200 dark:border-[#2a2f4a] overflow-hidden shadow-sm">
          <div className="px-4 sm:px-6 py-4 border-b border-slate-200 dark:border-[#2a2f4a] flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50 dark:bg-[#161820]">
            ...
            <div className="flex items-center gap-2 border border-slate-200 dark:border-[#2a2f4a] rounded-xl overflow-hidden bg-white dark:bg-[#1a1d27] w-full sm:w-auto">
              ...
              <input
                ...
                className="border-none text-sm px-3 py-2 focus:ring-0 w-full sm:w-48 outline-none bg-transparent text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500"
